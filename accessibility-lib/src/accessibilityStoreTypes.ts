 ...
 */
import { normalizeTextAdjustLevel, type TextAdjustLevel } from './textAdjustLevels'
...
export type DisplayTheme = 'standard' | 'light' | 'dark' | 'soft' | 'high-contrast' | 'invert'
...
export const UD_FONT_STACK = '"BIZ UDPGothic", "Hiragino Sans", "Yu Gothic UI", "Meiryo", sans-serif'
