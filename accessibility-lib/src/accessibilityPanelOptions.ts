...
export const AUTO_MODES: Exclude<AutoTextMode, 'off'>[] = ['viewport', 'content', 'combined']
...
export function bodyExpandLevelLabels(): Record<TextAdjustLevel, [string, string]> {
  return levelLabels(bodyTextExpandHint)
}

export function smallBoostLevelLabels(): Record<TextAdjustLevel, [string, string]> {
