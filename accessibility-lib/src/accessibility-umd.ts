...
import { bodyExpandLevelLabels, smallBoostLevelLabels, speechRateLabels } from './accessibilityPanelOptions'
import {
  A11Y_PRESETS,
  A11Y_PRESET_IDS,
  applyA11yPreset,
...
const FEATURES = {
  ...
  pageFont: {
    ...
    keys: ['fontSize', 'fontFamily', 'lineHeight', 'letterSpacing'] as const,
  },
  cues: {
    id: 'cues',
